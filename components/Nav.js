...
function Nav({
  ...
  const t = useT();
  const links = [['sobre', t('nav.sobre')], ['artigos', t('nav.artigos')], ['projetos', t('nav.projetos')], ['contribuicoes', t('nav.contribuicoes')], ['contato', t('nav.contato')]];
  return /*#__PURE__*/React.createElement("nav", {
    ...
    style: {
      color: lang === 'pt' ? 'var(--accent)' : 'var(--fg-3)'
    }
    ...
    style: {
      color: lang === 'en' ? 'var(--accent)' : 'var(--fg-3)'
    }
  ...
  }, '>', "_"), " ", t('nav.terminal')), /*#__PURE__*/React.createElement("button", {
