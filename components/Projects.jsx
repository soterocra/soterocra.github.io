...
function Glyph({ code }) {
  ...
  return (
    <div style={{
      ...
      color: 'var(--fg-2)', letterSpacing: '-.02em',
      flexShrink: 0,
    }}>{code}</div>
  );
}
  ...
  return (
    <section style={{
      ...
      <div className="project-grid" style={{
        ...
        {PROJECTS.map((p, i) => (
          <a key={i} href={p.href} target={p.href.startsWith('http') ? '_blank' : undefined}
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{
                  ...
                  {p.badge ? (
                    ...
                    }}>{p.badge === 'Contribuição' ? t('projects.contrib') : t('projects.article')}</span>
                  ) : (
                    <span>★ {p.stars}</span>
                  )}
                </div>
              ...
              <span className="proj-arrow" style={{
                ...
                fontSize: 14, transition: 'color .2s, transform .2s',
              }}>↗</span>
            </div>
            <p style={{
